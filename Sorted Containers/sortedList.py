"""
Use this when you want to perform efficient queries of the following type:
1. Add an element x to the list
2. Count the number of elements greater/smaller than x in the current list.

Since the elements in the list are kept sorted and indexing is possible, it is easy to apply binary search.

Go to the end for sample usage.

Here is a codeforces submission using this DS: https://codeforces.com/contest/1915/submission/275853544
"""
